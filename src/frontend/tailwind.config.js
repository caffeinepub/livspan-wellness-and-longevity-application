    ...
    theme: {
        ...
        extend: {
            ...
            boxShadow: {
                ...
                'glow-lg': '0 0 30px oklch(var(--luxury-gold) / 0.4), 0 0 60px oklch(var(--luxury-gold) / 0.2)',
                'glow-gold': '0 0 20px oklch(var(--luxury-gold) / 0.4), 0 0 40px oklch(var(--luxury-gold) / 0.2), inset 0 1px 2px oklch(var(--luxury-gold-bright) / 0.3)'
            },
            keyframes: {
                'accordion-down': {
                    from: { height: '0' },
                ...
                'glow-pulse': {
                    '0%, 100%': { 
                        boxShadow: '0 0 20px oklch(var(--luxury-gold) / 0.3), 0 0 40px oklch(var(--luxury-gold) / 0.1)' 
                    },
                    '50%': { 
                        boxShadow: '0 0 30px oklch(var(--luxury-gold) / 0.5), 0 0 60px oklch(var(--luxury-gold) / 0.25)' 
                    }
                },
                'shimmer': {
